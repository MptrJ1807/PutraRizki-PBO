...
class FrmTranslator:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Terjemah B.Jepang:').grid(row=2, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Terjemah B.Russia:').grid(row=3, column=0,
            sticky=W, padx=5, pady=5)
        Label(mainFrame, text='Terjemah B.Perancis:').grid(row=4, column=0,
            sticky=W, padx=5, pady=5)
    ...
    def onTranslate(self):
        ...
        hasil3 = penterjemah.translate(self.txtSumber.get(), src='id', dest='fr')
